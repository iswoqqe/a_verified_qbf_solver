...
subsubsection \<open>A QBF datatype\<close>

(* QBF formula based on HoS C30 *)
datatype QBF =
Var nat |
Neg QBF |
Conj "QBF list" |
...
subsubsection \<open>Formalization of Semantics \& Termination of Semantics\<close>
...
subsubsection \<open>Formalization of Satisfiability\<close>
